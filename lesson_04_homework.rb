...
# # Add a new party
waitlist.add_party('customer_one')
waitlist.add_party('customer_two')
waitlist.add_party('customer_three')
waitlist.add_party('customer_four')
waitlist.add_party('customer_five')

puts waitlist.list

puts ""

waitlist.add_party('customer_six')
